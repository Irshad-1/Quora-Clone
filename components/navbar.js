function navbar(){
    return `<div id="navbar">
     ...
     <div id="pagelinks">
         ...
         <div><a id="acolorchangea" href=""><i id="colorchange" class="fa-solid fa-list fa-lg"></i></a></div>
     ...
     <div id="searchAndAddQuestions">
         ...
         <a  href=""><img class="round" src="https://qsf.cf2.quoracdn.net/-4-images.new_grid.profile_default.png-26-688c79556f251aa0.png"/></a>
 ...
 function colorchange(){
    return document.querySelector(".fa-solid fa-list fa-lg").style.color="red";
     console.log("hi");
 }
