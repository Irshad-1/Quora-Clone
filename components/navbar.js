function navbar(){
   return `<div id="navbar">
    ...
    <div id="pagelinks">
        <div><a href="../landingPage.html"><i class="fa-solid fa-house fa-lg"></i></a></div>
        <div><a href=""><i class="fa-solid fa-list fa-lg"></i></a></div>
        <div><a href="../answer.html"><i class="fa-solid fa-pen-to-square fa-lg"></i></i></a></div>
        <div><a href="../spaces.html"><i class="fa-solid fa-people-group fa-lg"></i></a></div>
    ...
    <div id="searchAndAddQuestions">
        ...
        <div><a href="../addq.html" class="aq">Add Question</a>
